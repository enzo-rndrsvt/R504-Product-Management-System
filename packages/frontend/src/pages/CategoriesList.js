    ...
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-neutral-600">Manage your product categories</p>
        </div>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1">
          <div className="card shadow-md">
            <h2 className="mb-4 text-lg font-bold text-neutral-900">Add New Category</h2>
        ...
        <div className="lg:col-span-2">
          <div className="card shadow-md">
            <h2 className="mb-4 text-lg font-bold text-neutral-900">Categories</h2>

            {categories.length === 0 ? (
              <div className="rounded-lg border-2 border-dashed border-neutral-300 bg-neutral-50 py-8 text-center">
                <p className="text-neutral-600">No categories yet</p>
                <p className="mt-1 text-sm text-neutral-500">Create your first category to get started</p>
              </div>
            ) : (
                ...
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="ml-4 rounded-lg bg-red-100 px-3 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-200"
                    >
                      Delete
                    </button>
                  </div>
